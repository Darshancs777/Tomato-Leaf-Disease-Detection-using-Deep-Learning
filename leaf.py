...
filepath = 'D:\\Tomato Leaf Disease Detection using Deep Learning\\model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:\\Tomato Leaf Disease Detection using Deep Learning\\static\\upload', filename)
        file.save(file_path)
